...
export default function Programmers() {
  ...
  const [selectedProgrammers, setSelectedProgrammers] = useState(null)
  ...
  return programmers.find(pr => pr.id === selectedProgrammers).name
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: selectedProgrammers ? 'gold': 'royalblue', // 🤔 color turns to gold, when celebrating
  };
